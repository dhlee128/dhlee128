...
public class StockData {
    ...
    public StockData(String con1, String con2, String con3, String con4, String con5, String con6, String con7, String con8, String con9, String con10, String con11
    ...
    public void readDataExternal(DataInputStream stream) {

        try {

            stream.read(con1, 0, con1.length);

            stream.read(con2, 0, con2.length);

            stream.read(con3, 0, con3.length);

            stream.read(con4, 0, con4.length);

            stream.read(con5, 0, con5.length);

            stream.read(con6, 0, con6.length);

            stream.read(con7, 0, con7.length);

            stream.read(con8, 0, con8.length);

            stream.read(con9, 0, con9.length);

            stream.read(con10, 0, con10.length);

            stream.read(con11, 0, con11.length);
